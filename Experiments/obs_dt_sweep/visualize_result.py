...
def visualize_dataset(file_path):
    ...
    """
    file_path = Path(__file__).parent / Path(file_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--file", type=str, default="runs/butterfly/state_aug_enkf_with_offset/obs_pred_results/obs_dt_0.0100.pt", help="Path to the .pt file.")
